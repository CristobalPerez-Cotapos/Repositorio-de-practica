...
from frontend.Vetana_puntajes import Ventana_puntajes
...
ventana_puntajes = Ventana_puntajes(p.ANCHO, p.LARGO)
...
ventana_puntajes.senal_vovler_puntajes.connect(ventana_inicio.show)

ventana_juego = Ventana_juego(640, 480)
...
ventana_post_ronda.senal_salir_post_ronda.connect(ventana_inicio.show)
